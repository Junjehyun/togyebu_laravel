...
@section('content')
    <div class="flex flex-col items-center justify-center gap-8 py-10 px-4 min-h-screen">
        <p class="text-left text-lg leading-relaxed text-gray-800 ">
        ...
        <a href="{{ route('main.index') }}">
            <img src="{{ asset('images/tgb_intro_logo.png') }}" alt="Intro" class="w-full max-w-lg h-auto rounded-2xl mt-5">
        </a>
    </div>
@endsection